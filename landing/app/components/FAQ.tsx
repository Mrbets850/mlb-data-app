...
const faqItems = [
  ...
  },
  {
    ...
    a: "You get full, unrestricted access to The MLB Edge for 3 days at no cost. If you cancel during the trial, you won't be charged at all. After the trial ends, you'll be charged a one-time payment of $4.99 — and that's it. No recurring fees, no auto-renewals.",
  },
  {
    q: "Is this a subscription or a one-time payment?",
    a: "It's a one-time payment. After your 3-day free trial, you're charged $4.99 once. There are no monthly bills, no recurring charges, and no surprises on your credit card.",
  },
  {
