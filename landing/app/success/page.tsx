...
export const metadata = {
  ...
  description: "Your subscription is active. Start exploring MLB analytics.",
};
    ...
    <div className="relative z-1 min-h-screen flex items-center justify-center px-6">
      ...
      <div className="relative text-center max-w-md mx-auto">
        ...
        <p className="text-text-muted text-sm mb-8">
          Check your email for a confirmation from Stripe. Billing starts at
          $4.99/month after your trial ends.
        </p>
